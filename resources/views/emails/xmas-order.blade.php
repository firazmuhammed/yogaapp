        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
          <tr>
            <td align="left" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
              <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;">Christmas Order 2022</h1>
            </td>
          </tr>
        </table>
        <!--[if (gte mso 9)|(IE)]>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                      ...
                      <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 300px;">
                        <tr>
                          <td align="left" valign="top" style="padding-bottom: 36px; padding-left: 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                            ...
                            <p>{{$info->name}}<br>
                              @if($info->order_type=="Home Delivery")
                              {{ $info->address }}
                              @else
                              {{$info->street}}<br>{{$info->suburb}} <br>{{$info->pincode}} <br> {{$info->state}}</p>
                              @endif
          ...
          <tr>
            ...
            <td align="left" bgcolor="#ffffff" style="padding: 24px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td align="left"  width="75%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>  @if($info->order_type=="Home Delivery") Home Delivery @else Pick up @endif  -{{\Carbon::parse($info->delivery_date)->format('M d Y')}} </strong></td>
               ...
               @endforeach
               <tr>
                @if($info->order_type=="Home Delivery") <td align="left" bgcolor="#D2C7BA" width="75%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>@if($info->order_amount<800)  Delivery charge :20  @endif</strong></td>@endif
                ...
                <td align="left" bgcolor="#D2C7BA" width="25%" style="padding: 12px;font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;"><strong>@if($info->order_type=="Home Delivery") @if($info->order_amount<800) {{ $info->order_amount+20 }} @else {{ $info->order_amount }}@endif @else{{ $info->order_amount }} @endif</strong></td>
              </tr>
              </table>
              <p>Payment method :  {{$info->payment_method}}</p>
              <p>Remaining amount :  {{$info->advance}}</p>
            </td>
