        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"> Post Code</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header ">
                ...
                <h3 class="card-title">List Post Code</h3>
                <a class="btn btn-success" href="{{url('dashboard/add-post-code')}}">+</a>
                  </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                       <a class="badge bg-primary" href="{{url('dashboard/edit-post-code').'/'.$code->id}}">Edit </a> 
                      
                        <a class="badge bg-red"  href="{{url('dashboard/delete-post-code').'/'.$code->id}}" id="deleteProductId" >Delete</a>
