        ...
        <div class="container-fluid">
          ...
          <div class="card card-default">
            ...
            <div class="card-body" x-show="open">
              <form method="post" action="{{url('dashboard/update-bulk-product')}}" enctype='multipart/form-data' >
                @csrf
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Price</label>
                    <input type="text" name="unit_price"  value="{{ $product->unit_price}}" required class="form-control">
                  </div>
                  <div class="form-group">
                    <label>Unit</label>
