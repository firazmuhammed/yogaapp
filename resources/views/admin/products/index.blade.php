          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header ">
                ...
                <a class="btn btn-success" href="{{url('dashboard/add-product')}}">+</a>
                  </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                       <a class="badge bg-primary" href="{{url('dashboard/edit-product').'/'.$product->id}}">Edit </a> 
                      
                        <a class="badge bg-red"  href="{{url('dashboard/delete-product').'/'.$product->id}}" id="deleteProductId" products_id="695">Delete</a>
