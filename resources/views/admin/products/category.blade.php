          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header ">
                ...
                <a class="btn btn-success" href="{{url('dashboard/add-category')}}">+</a>
                  </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  {{ $a }}
                    ...
                    <td>
                      <img style="width: 100px" src="{{ asset('public/images/category/'.$cat->category_image ) }}" />
                    </td>
                  
                    <td>
                       <a class="badge bg-primary" href="{{url('dashboard/edit-category')}}">Edit </a> 
                      
                        <a class="badge bg-red"  href="{{url('dashboard/delete-category/'.$cat->id)}}" id="deleteProductId" products_id="695">Delete</a>
