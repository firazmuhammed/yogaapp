...
@section('content')
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{\Carbon::parse($order->date_of_delivery)->format('M d Y')}}</td>
                    <td>  {{$order->abn_number}}</td>
                    ...
                    <td>
                      ...
                      <a href="{{ url('dashboard/view-invoice-bulk-order').'/'.$order->id }}" option_id="" class="badge bg-green"><i class="fa fa-eye" aria-hidden="true"></i></a>
  ...
  <!-- /.control-sidebar -->
  <form id="print" method="POST" action="{{ url('dashboard/print-bulk') }}">
    @csrf
